...
import { Button, Container, Typography, Stepper, Step, StepLabel, Box, Alert } from "@mui/material";
import { generateMnemonic } from "../crypto/seedManager.js";
import { mnemonicToSeed } from "../crypto/seedManager.js";
...
export default function WalletSetup() {
  ...
  const handleGenerate = () => {
    try {
      setError("");
      const newMnemonic = generateMnemonic(128); // 12 parole
  ...
  return (
    <PageBase title="Configura Wallet">
          ...
          {activeStep === 2 && (
            <Box textAlign="center">
              ...
              <Alert severity="warning" sx={{ mb: 3 }}>
                <strong>Importante:</strong> Senza la seed phrase non potrai mai recuperare
                l'accesso al tuo wallet. Assicurati di averla salvata!
              </Alert>
        ...
        {activeStep === 0 && (
          <Box textAlign="center" sx={{ mt: 4 }}>
            <Typography variant="body2" color="text.secondary">
              Hai già un wallet?{" "}
              <Button href="/import-wallet" size="small">
                Importa Seed Phrase
              </Button>
            </Typography>
          </Box>
